...
if __name__=='__main__':
	...
	parser.add_option("-i", "--input", dest="input", default="./steamaccounthistory.html", help="Path of input HTML file")
	parser.add_option("-o", "--output", dest="output", default="./steamaccounthistory.csv", help="Path of output CSV file")
	parser.add_option("-s", "--stat-output", dest="statoutput", default="./steamaccounthistorystats.txt", help="Path of output stats file")
